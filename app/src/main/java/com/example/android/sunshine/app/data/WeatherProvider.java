...
public class WeatherProvider extends ContentProvider {
    ...
    static UriMatcher buildUriMatcher() {
        ...
        UriMatcher rename = new UriMatcher(UriMatcher.NO_MATCH);

        // 2) Use the addURI function to match each of the types.  Use the constants from
        // WeatherContract to help define the types to the UriMatcher.
        rename.addURI(WeatherContract.CONTENT_AUTHORITY, "weather", WEATHER);
        rename.addURI(WeatherContract.CONTENT_AUTHORITY, "weather/*", WEATHER_WITH_LOCATION);
        rename.addURI(WeatherContract.CONTENT_AUTHORITY, "weather/*/#", WEATHER_WITH_LOCATION_AND_DATE);
        rename.addURI(WeatherContract.CONTENT_AUTHORITY, "location", LOCATION);
